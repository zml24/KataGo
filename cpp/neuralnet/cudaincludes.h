...
#include <cuda_fp8.h>
#define KATAGO_CUDA_FP8_AVAILABLE 1
#endif
...
#if defined(KATAGO_CUDA_FP8_AVAILABLE) && defined(KATAGO_CUBLASLT_AVAILABLE) && defined(KATAGO_CUDA_TRANSFORMER_BFLOAT16_AVAILABLE)
#define KATAGO_CUDA_TRANSFORMER_FP8_AVAILABLE 1
#endif
